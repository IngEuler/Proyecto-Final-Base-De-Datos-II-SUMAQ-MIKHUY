...
--INDICES
-- 1️ Índice para relación Pedido → Cliente
...
-- 2️ Índice para relación DetallePedido → Pedido
...
FROM Pedido
WHERE idCliente = 10
AND fechaPedido BETWEEN '2026-02-11' AND '2026-02-12';



-- 3️ Índice para relación DetallePedido → Plato
CREATE INDEX IX_DetallePedido_idPlato
ON DetallePedido(idPlato);
...
-- 4️ Índice para búsquedas por fecha de pedido
CREATE INDEX IX_Pedido_fechaPedido
ON Pedido(fechaPedido);

SELECT *
FROM Pedido
WHERE fechaPedido = '2026-02-11 10:30';


-- 5️ Índice compuesto para reportes por cliente y fecha
CREATE INDEX IX_Pedido_Cliente_Fecha
ON Pedido(idCliente, fechaPedido);

SELECT *
FROM Pedido
WHERE idCliente = 10
AND fechaPedido BETWEEN '2026-02-11 00:00'
AND '2026-02-12 23:59';
